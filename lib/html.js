import {aarray} from '/lib/iteration.js';
...
HTML.fragment.from = (...args) => HTMLPieces.from(...args).fragment();

HTML.element = (...args) => HTMLPieces.literal(...args).element();
HTML.element.from = (...args) => HTMLPieces.from(...args).element();

HTML.string = (...args) => HTMLPieces.literal(...args).string();
HTML.string.from = (...args) => HTMLPieces.from(...args).string();
